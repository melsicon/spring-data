...
maven_install(
    artifacts = [
        ...
        "org.eclipse.jetty:jetty-webapp:10.0.4",
        ...
        "org.springframework.data:spring-data-rest-core:3.5.1",
        "org.springframework.data:spring-data-rest-hal-explorer:3.5.1",
        "org.springframework.data:spring-data-rest-webmvc:3.5.1",
